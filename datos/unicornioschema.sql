...
CREATE TABLE `gameinventory` (
  `inventory_id` tinyint unsigned  PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `gadget_id` tinyint unsigned NOT NULL, 
  `inventory_space` tinyint unsigned NOT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `game_assets` (
  `asset_id`  tinyint unsigned PRIMARY KEY NOT NULL,
  `asset_type` varchar(45) NOT NULL
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE `gadgets` (
  `gadget_ID` tinyint unsigned PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  `ability_speed` tinyint unsigned  NOT NULL,
  `ability_strength` tinyint unsigned  NOT NULL,
  `ability_agility` tinyint unsigned  NOT NULL,
  `ability_shield` tinyint unsigned  NOT NULL,
...
CREATE TABLE `killer_sprites` (
  `killersprite_Id` tinyint unsigned PRIMARY KEY NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
...
CREATE TABLE `shields` (
  `shield_id`  tinyint unsigned PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `game_history` (
  ...
  `inventory_id` tinyint unsigned NOT NULL,
